...
public class LargeFireParticle extends DragonParticle {
    ...
    public static final class Factory implements ParticleProvider<Data> {
        ...
        @Override
        public @NotNull Particle createParticle(@NotNull Data pType, @NotNull ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            LargeFireParticle particle = new LargeFireParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, pType.duration(), pType.swirls(), spriteSet);
