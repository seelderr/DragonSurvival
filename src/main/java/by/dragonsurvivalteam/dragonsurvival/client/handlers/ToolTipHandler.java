...
public class ToolTipHandler{
	...
	public class ToolTipHandler{
		...
		public static void checkIfDragonFood(ItemTooltipEvent tooltipEvent){
			...
			@SubscribeEvent public static void itemDescriptions (ItemTooltipEvent event){
				...
				private static boolean isHelpText () {
					...
					for(GuiEventListener btn : Minecraft.getInstance().screen.children){
						if(btn instanceof HelpButton && ((HelpButton)btn).isHoveredOrFocused()){
							...
							@SubscribeEvent public static void postScreenRender (GuiScreenEvent.DrawScreenEvent.Post event){
								if(Minecraft.getInstance().screen != null && Minecraft.getInstance().screen.buttons != null){
									for(Widget btn : Minecraft.getInstance().screen.buttons){
										if(btn instanceof HelpButton && btn.isHoveredOrFocused()){
							...
							public static void onPostTooltipEvent (RenderTooltipEvent.Pre event){
								...
								public static void onPostTooltipEvent (RenderTooltipEvent.PostText event){
									...
									Minecraft.getInstance().getTextureManager().bindForSetup(blink ? tooltip_2 : tooltip_1);
								...
								@SubscribeEvent public static void onTooltipColorEvent (RenderTooltipEvent.Color event){
									...
									if(screen){
										for(GuiEventListener widget : ((AbilityScreen)Minecraft.getInstance().screen).children()){
											if(widget instanceof SkillProgressButton && ((SkillProgressButton)widget).isHoveredOrFocused()){
												...
												if(screen){
													for(Widget widget : ((AbilityScreen)Minecraft.getInstance().screen).widgetList()){
														if(widget instanceof SkillProgressButton && widget.isHoveredOrFocused()){
															button = true;
															break;
														}
													}
											...
											@SubscribeEvent public static void renderTooltips (ScreenEvent.DrawScreenEvent.Post event){
