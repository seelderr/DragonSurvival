...
public class ServerConfig{
	...
	ServerConfig(ForgeConfigSpec.Builder builder){
		...
		caveDragonFoods = builder.worldRestart().translation("ds.config.server.food.caveDragonFoods").comment("Dragon food formatting: item/tag:modid:id:food:saturation").defineList("caveDragon", Arrays.asList("tag:minecraft:coals:1:1", "item:minecraft:charcoal:1:2", "item:dragonsurvival:charged_coal:6:1", "item:dragonsurvival:charred_meat:8:10", "item:dragonsurvival:cave_dragon_treat:4:8", "item:dragonsurvival:charred_seafood:7:11", "item:dragonsurvival:charred_vegetable:8:9", "item:dragonsurvival:charred_mushroom:9:9", "item:dragonsurvival:charged_soup:15:15", "item:dragonsurvival:hot_dragon_rod:4:15", "item:dragonsurvival:explosive_copper:6:4", "item:dragonsurvival:double_quartz:8:6", "item:dragonsurvival:quartz_explosive_copper:12:18", "item:netherdepthsupgrade:blazefish:6:7", "item:netherdepthsupgrade:cooked_magmacubefish_slice:2:2", "item:netherdepthsupgrade:blazefish_slice:2:2", "item:infernalexp:molten_gold_cluster:2:6", "item:netherdepthsupgrade:magmacubefish:6:7", "item:desolation:cinder_fruit:6:7", "item:desolation:powered_cinder_fruit:8:12", "item:desolation:activatedcharcoal:2:2", "item:desolation:infused_powder:10:10", "item:desolation:primed_ash:7:8", "item:undergarden:ditchbulb:5,6", "item:xreliquary:molten_core:1:1", "item:silents_mechanisms:coal_generator_fuels:1:1", "item:mekanism:dust_charcoal:1:1", "item:mekanism:dust_coal:1:1", "item:rats:nether_cheese", "item:potionsmaster:charcoal_powder:1:1", "item:potionsmaster:coal_powder:1:1", "item:potionsmaster:activated_charcoal:2:2", "item:thermal:coal_coke:1:1", "item:infernalexp:glowcoal:2:3", "item:resourcefulbees:coal_honeycomb:5:5", "item:resourcefulbees:netherite_honeycomb:5:5", "item:lazierae2:coal_dust:1:1", "item:silents_mechanisms:coal_dust:1:1", "item:potionsmaster:calcinatedcoal_powder:1:1", "item:thermal:basalz_rod:2:4", "item:thermal:basalz_powder:1:2", "item:druidcraft:fiery_glass:2:2", "item:create:blaze_cake:10:10", "item:create:creative_blaze_cake:50:50", "item:upgradednetherite:fire_essence:12:4", "item:netherdepthsupgrade:fortress_grouper:3:1", "item:nethersdelight:nether_skewer:6:8"), ConfigHandler.itemsAndTagsPredicate.and(this::isValidFoodConfig));

		forestDragonFoods = builder.worldRestart().translation("ds.config.server.food.forestDragonFoods").comment("Dragon food formatting: item/tag:modid:id:food:saturation").defineList("forestDragon", Arrays.asList("tag:forge:raw_meats:5:7", "item:minecraft:glow_berries:2:1", "item:minecraft:sweet_berries:1:1", "item:minecraft:rotten_flesh:2:4", "item:minecraft:spider_eye:6:8", "item:minecraft:rabbit:7:8", "item:minecraft:poisonous_potato:7:8", "item:minecraft:chorus_fruit:9:8", "item:minecraft:brown_mushroom:2:1", "item:minecraft:red_mushroom:2:3", "item:minecraft:honey_bottle:6:1", "item:minecraft:warped_fungus:3:3", "item:minecraft:crimson_fungus:3:3", "item:dragonsurvival:forest_dragon_treat:4:8", "item:dragonsurvival:meat_chorus_mix:12:8", "item:nocubes_better_frogs:raw_frog_leg:4:4", "item:infernalexp:raw_hogchop:6:6", "item:phantasm:chorus_fruit_salad:10:10", "item:dragonsurvival:meat_wild_berries:12:10", "item:dragonsurvival:smelly_meat_porridge:6:10", "item:dragonsurvival:diamond_chorus:15:12", "item:dragonsurvival:luminous_ointment:5:3", "item:dragonsurvival:sweet_sour_rabbit:10:6", "item:chinchillas:chinchilla_meat:6:8", "item:aquaculture:turtle_soup:8:8", "item:netherdepthsupgrade:wither_bonefish:4:6", "item:netherdepthsupgrade:bonefish:4:6", "item:infernalexp:raw_hogchop:8:8", "item:aoa3:fiery_chops:6:7", "item:aoa3:raw_chimera_chop:6:7", "item:aoa3:raw_furlion_chop:6:7", "item:aoa3:raw_halycon_beef:7:8", "item:aoa3:raw_charger_shank:6:7", "item:aoa3:trilliad_leaves:8:11", "item:pamhc2foodextended:rawtofabbititem", "item:pamhc2foodextended:rawtofickenitem", "item:quark:golden_frog_leg:12:14", "item:pamhc2foodextended:rawtofuttonitem", "item:alexsmobs:kangaroo_meat:5:6", "item:alexsmobs:moose_ribs:6:8", "item:simplefarming:raw_horse_meat:5:6", "item:simplefarming:raw_bacon:3:3", "item:simplefarming:raw_chicken_wings:2:3", "item:simplefarming:raw_sausage:3:4", "item:xenoclustwo:raw_tortice:7:8", "item:unnamedanimalmod:musk_ox_shank:7:8", "item:unnamedanimalmod:frog_legs:5:6", "item:unnamedanimalmod:mangrove_fruit:4:7", "item:betteranimalsplus:venisonraw:7:6", "item:betteranimalsplus:pheasantraw:7:5", "item:betteranimalsplus:turkey_leg_raw:4:5", "item:infernalexp:raw_hogchop:6:7", "item:infernalexp:cured_jerky:10:7", "item:rats:raw_rat:4:5", "item:aquaculture:frog:4:5", "item:aquaculture:frog_legs_raw:4:4", "item:aquaculture:box_turtle:4:5", "item:aquaculture:arrau_turtle:4:5", "item:aquaculture:starshell_turtle:4:5", "item:undergarden:raw_gloomper_leg:4:5", "item:undergarden:raw_dweller_meat:6:7", "item:farmersdelight:chicken_cuts:3:3", "item:farmersdelight:bacon:3:3", "item:farmersdelight:ham:9:10", "item:farmersdelight:minced_beef:5:3", "item:farmersdelight:mutton_chops:5:3", "item:abnormals_delight:duck_fillet:2:3", "item:abnormals_delight:venison_shanks:7:3", "item:autumnity:foul_berries:2:4", "item:autumnity:turkey:7:8", "item:autumnity:turkey_piece:2:4", "item:autumnity:foul_soup:12:8", "item:endergetic:bolloom_fruit:3:4", "item:quark:frog_leg:4:5", "item:nethers_delight:hoglin_loin:8:6", "item:nethers_delight:raw_stuffed_hoglin:18:10", "item:xreliquary:zombie_heart:4:7", "item:xreliquary:bat_wing:2:2", "item:eidolon:zombie_heart:7:7", "item:forbidden_arcanus:bat_wing:5:2", "item:twilightforest:raw_venison:7:7", "item:twilightforest:raw_meef:9:5", "item:twilightforest:hydra_chop", "item:cyclic:chorus_flight", "item:cyclic:chorus_spectral", "item:cyclic:toxic_carrot:15:15", "item:artifacts:everlasting_beef", "item:resourcefulbees:rainbow_honey_bottle", "item:resourcefulbees:diamond_honeycomb:5:5", "item:byg:soul_shroom:9:5", "item:byg:death_cap:9:8", "item:minecolonies:chorus_bread", "item:wyrmroost:raw_lowtier_meat:3:2", "item:wyrmroost:raw_common_meat:5:3", "item:wyrmroost:raw_apex_meat:8:6", "item:wyrmroost:raw_behemoth_meat:11:12", "item:wyrmroost:desert_wyrm:4:3", "item:eanimod:rawchicken_darkbig:9:5", "item:eanimod:rawchicken_dark:5:4", "item:eanimod:rawchicken_darksmall:3:2", "item:eanimod:rawchicken_pale:5:3", "item:eanimod:rawchicken_palesmall:4:3", "item:eanimod:rawrabbit_small:4:4", "item:environmental:duck:4:3", "item:environmental:venison:7:7", "item:cnb:lizard_item_jungle:4:4", "item:cnb:lizard_item_mushroom:4:4", "item:cnb:lizard_item_jungle_2:4:4", "item:cnb:lizard_item_desert_2:4:4", "item:cnb:lizard_egg:5:2", "item:cnb:lizard_item_desert:4:4", "item:snowpig:frozen_porkchop:7:3", "item:snowpig:frozen_ham:5:7", "item:untamedwilds:spawn_snake:4:4", "item:untamedwilds:snake_green_mamba:4:4", "item:untamedwilds:snake_rattlesnake:4:4", "item:untamedwilds:snake_emerald:4:4", "item:untamedwilds:snake_carpet_python:4:4", "item:untamedwilds:snake_corn:4:4", "item:untamedwilds:snake_gray_kingsnake:4:4", "item:untamedwilds:snake_coral:4:4", "item:untamedwilds:snake_ball_python:4:4", "item:untamedwilds:snake_black_mamba:4:4", "item:untamedwilds:snake_western_rattlesnake:4:4", "item:untamedwilds:snake_taipan:4:4", "item:untamedwilds:snake_adder:4:4", "item:untamedwilds:snake_rice_paddy:4:4", "item:untamedwilds:snake_coral_blue:4:4", "item:untamedwilds:snake_cave_racer:4:4", "item:untamedwilds:snake_swamp_moccasin:4:4", "item:untamedwilds:softshell_turtle_pig_nose:4:4", "item:untamedwilds:softshell_turtle_flapshell:4:4", "item:untamedwilds:softshell_turtle_chinese:4:4", "item:untamedwilds:tortoise_asian_box:4:4", "item:untamedwilds:tortoise_gopher:4:4", "item:untamedwilds:tortoise_leopard:4:4", "item:untamedwilds:spawn_softshell_turtle:4:4", "item:untamedwilds:softshell_turtle_nile:4:4", "item:untamedwilds:softshell_turtle_spiny:4:4", "item:untamedwilds:tortoise_sulcata:4:4", "item:untamedwilds:tortoise_star:4:4", "item:untamedwilds:spawn_tortoise:4:4", "item:naturalist:venison:7:6", "item:leescreatures:raw_boarlin:6:6", "item:mysticalworld:venison:5:5", "item:toadterror:toad_chops:8:7", "item:prehistoricfauna:raw_large_thyreophoran_meat:7:6", "item:prehistoricfauna:raw_large_marginocephalian_meat:8:6", "item:prehistoricfauna:raw_small_ornithischian_meat:4:3", "item:prehistoricfauna:raw_large_sauropod_meat:11:9", "item:prehistoricfauna:raw_small_sauropod_meat:4:4", "item:prehistoricfauna:raw_large_theropod_meat:7:7", "item:prehistoricfauna:raw_small_theropod_meat:4:4", "item:prehistoricfauna:raw_small_archosauromorph_meat:3:3", "item:prehistoricfauna:raw_large_archosauromorph_meat:6:5", "item:prehistoricfauna:raw_small_reptile_meat:4:3", "item:prehistoricfauna:raw_large_synapsid_meat:5:6", "item:ends_delight:dragon_leg:15:15", "item:ends_delight:raw_dragon_meat:10:10", "item:ends_delight:raw_dragon_meat_cuts:5:2", "item:ends_delight:dragon_breath_and_chorus_soup:15:15", "item:ends_delight:ender_sauce:8:15", "item:ends_delight:raw_ender_mite_meat:1:1", "item:ends_delight:non_hatchable_dragon_egg:8:5", "item:ends_delight:shulker_meat:7:4", "item:unusualend:chorus_juice:2:2", "item:ends_delight:liquid_dragon_egg:3:3", "item:ends_delight:shulker_meat_slice:4:1", "item:unusualend:ender_firefly_egg:2:3", "item:unusualend:chorus_petal:1:1", "item:unusualend:chorus_pie:3:4", "item:unusualend:ender_stew:6:1", "item:unusualprehistory:kentro_eggs:3:3", "item:unusualprehistory:hwacha_eggs:3:3", "item:unusualprehistory:ulugh_eggs:3:3", "item:unusualprehistory:antarcto_eggs:3:3", "item:unusualprehistory:austro_eggs:3:3", "item:unusualprehistory:pachy_eggs:3:3", "item:unusualprehistory:raptor_eggs:3:3", "item:unusualprehistory:trike_eggs:4:4", "item:unusualprehistory:rex_eggs:6:3", "item:unusualprehistory:coty_eggs:3:3", "item:unusualprehistory:meaty_buffet:12:15", "item:unusualprehistory:majunga_eggs:3:3", "item:unusualprehistory:anuro_eggs:3:3", "item:unusualprehistory:raw_austro:6:3", "item:unusualprehistory:raw_coty:5:3", "item:nourished_nether:raw_hoglin:8:8", "item:gothic:meat:7:8", "item:gothic:bug_meat:2:2", "item:gothic:scavenger_egg:3:3", "item:gothic:snapperweed:1:1", "item:gothic:blue_elder:1:1", "item:unusualend:wandering_stew:1:1", "item:nethersdelight:raw_stuffed_hoglin:15:15", "item:nethersdelight:hoglin_ear:1:1", "item:nethersdelight:ground_strider:6:2", "item:nethersdelight:strider_slice:8:8", "item:nethersdelight:hoglin_ear:1:1", "item:nethersdelight:hoglin_loin:6:6", "item:nethersdelight:propelpearl:1:1", "item:orcz:squig_eye:6:6", "item:orcz:orceye:4:4", "item:goated:chevon:6:6", "item:rottencreatures:frozen_rotten_flesh:4:4", "item:regions_unexplored:tall_green_bioshroom:3:3", "item:regions_unexplored:green_bioshroom:3:3", "item:regions_unexplored:blue_bioshroom:3:3", "item:regions_unexplored:tall_blue_bioshroom:3:3", "item:regions_unexplored:tall_pink_bioshroom:3:3", "item:regions_unexplored:pink_bioshroom:3:3", "item:regions_unexplored:yellow_bioshroom:3:3", "item:regions_unexplored:tall_yellow_bioshroom:3:3", "item:quark:glow_shroom:3:3", "item:gothic:cave_mushrooms:3:3", "item:gothic:tall_mushrooms:3:3", "item:gothic:miners_food_wild:3:3", "item:gothic:black_mushroom:3:3", "item:phantasm:putac_shroom:3:3", "item:farmersdelight:red_mushroom_colony:10:3", "item:farmersdelight:brown_mushroom_colony:10:3", "item:gothic:miners_food:3:3", "item:gothic:black_mushroom_item:3:3", "item:gothic:blue_elder:3:3", "item:frozen_delight:truffle_slice:4:8", "item:frozenup:truffle:8:4", "item:frozen_delight:mushroom_mix:16:3", "item:nourished_nether:nether_fungus_stew:7:3", "item:nethersdelight:warped_fungus_colony:10:3", "item:nethersdelight:crimson_fungus_colony:10:3", "item:unusualend:chorus_fungus:3:3", "item:orcz:orcshroom:3:3", "item:orcz:blue_orcshroom:3:3", "item:waterstrainer:worm:1:1", "item:aquaculture:worm:1:1"), ConfigHandler.itemsAndTagsPredicate.and(this::isValidFoodConfig));

		seaDragonFoods = builder.worldRestart().translation("ds.config.server.food.seaDragonFoods").comment("Dragon food formatting: item/tag:modid:id:food:saturation").defineList("seaDragon", Arrays.asList("tag:forge:raw_fishes:6:7", "item:minecraft:kelp:1:1", "item:minecraft:pufferfish:8:8", "item:dragonsurvival:sea_dragon_treat:4:8", "item:dragonsurvival:seasoned_fish:12:10", "item:dragonsurvival:golden_coral_pufferfish:12:14", "item:dragonsurvival:frozen_raw_fish:2:1", "item:dragonsurvival:golden_turtle_egg:15:12", "item:aoa3:raw_candlefish:9:9", "item:aoa3:raw_crimson_skipper:8:8", "item:aoa3:raw_fingerfish:4:4", "item:aoa3:raw_pearl_stripefish:5:4", "item:aoa3:raw_limefish:5:5", "item:aoa3:raw_sailback:6:5", "item:netherdepthsupgrade:soulsucker:6:7", "item:netherdepthsupgrade:obsidianfish:6:7", "item:netherdepthsupgrade:lava_pufferfish:8:7", "item:netherdepthsupgrade:searing_cod:6:7", "item:netherdepthsupgrade:glowdine:6:7", "item:netherdepthsupgrade:warped_kelp:2:2", "item:netherdepthsupgrade:lava_pufferfish_slice:2:2", "item:netherdepthsupgrade:glowdine_slice:2:2", "item:netherdepthsupgrade:soulsucker_slice:2:2", "item:netherdepthsupgrade:obsidianfish_slice:2:2", "item:netherdepthsupgrade:searing_cod_slice:2:2", "item:crittersandcompanions:clam:10:3", "item:aoa3:raw_golden_gullfish:10:2", "item:aoa3:raw_turquoise_stripefish:7:6", "item:aoa3:raw_violet_skipper:7:7", "item:aoa3:raw_rocketfish:4:10", "item:aoa3:raw_crimson_stripefish:8:7", "item:aoa3:raw_sapphire_strider:9:8", "item:aoa3:raw_dark_hatchetfish:9:9", "item:aoa3:raw_ironback:10:9", "item:aoa3:raw_rainbowfish:11:11", "item:aoa3:raw_razorfish:12:14", "item:alexsmobs:lobster_tail:4:5", "item:alexsmobs:blobfish:8:9", "item:oddwatermobs:raw_ghost_shark:8:8", "item:oddwatermobs:raw_isopod:4:2", "item:oddwatermobs:raw_mudskipper:6:7", "item:oddwatermobs:raw_coelacanth:9:10", "item:oddwatermobs:raw_anglerfish:6:6", "item:oddwatermobs:deep_sea_fish:4:2", "item:oddwatermobs:crab_leg:5:6", "item:simplefarming:raw_calamari:5:6", "item:unnamedanimalmod:elephantnose_fish:5:6", "item:unnamedanimalmod:flashlight_fish:5:6", "item:unnamedanimalmod:rocket_killifish:5:6", "item:unnamedanimalmod:leafy_seadragon:5:6", "item:unnamedanimalmod:elephantnose_fish:5:6", "item:betteranimalsplus:eel_meat_raw:5:6", "item:betteranimalsplus:calamari_raw:4:5", "item:betteranimalsplus:crab_meat_raw:4:4", "item:aquaculture:fish_fillet_raw:2:2", "item:aquaculture:goldfish:8:4", "item:aquaculture:algae:3:2", "item:betterendforge:end_fish_raw:6:7", "item:betterendforge:hydralux_petal:3:3", "item:betterendforge:charnia_green:2:2", "item:shroomed:raw_shroomfin:5:6", "item:undergarden:raw_gwibling:5:6", "item:bettas:betta_fish:4:5", "item:quark:crab_leg:4:4", "item:pamhc2foodextended:rawtofishitem", "item:fins:banded_redback_shrimp:6:1", "item:fins:night_light_squid:6:2", "item:fins:night_light_squid_tentacle:6:2", "item:fins:emerald_spindly_gem_crab:7:2", "item:fins:amber_spindly_gem_crab:7:2", "item:fins:rubby_spindly_gem_crab:7:2", "item:fins:sapphire_spindly_gem_crab:7:2", "item:fins:pearl_spindly_gem_crab:7:2", "item:fins:papa_wee:6:2", "item:fins:bugmeat:4:2", "item:fins:raw_golden_river_ray_wing:6:2", "item:fins:red_bull_crab_claw:4:4", "item:fins:white_bull_crab_claw:4:4", "item:fins:wherble_fin:1:1", "item:forbidden_arcanus:tentacle:5:2", "item:pneumaticcraft:raw_salmon_tempura:6:10", "item:rats:ratfish:4:2", "item:upgrade_aquatic:purple_pickerelweed:2:2", "item:upgrade_aquatic:blue_pickerelweed:2:2", "item:upgrade_aquatic:polar_kelp:2:2", "item:upgrade_aquatic:tongue_kelp:2:2", "item:upgrade_aquatic:thorny_kelp:2:2", "item:upgrade_aquatic:ochre_kelp:2:2", "item:upgrade_aquatic:lionfish:8:9", "item:aquaculture:sushi:6:5", "item:freshwarriors:fresh_soup:15:10", "item:freshwarriors:beluga_caviar:10:3", "item:freshwarriors:piranha:4:1", "item:freshwarriors:tilapia:4:1", "item:freshwarriors:stuffed_piranha:4:1", "item:freshwarriors:tigerfish:5:5", "item:freshwarriors:toe_biter_leg:3:3", "item:untamedwilds:egg_arowana:4:4", "item:untamedwilds:egg_trevally_jack:4:4", "item:untamedwilds:egg_trevally:4:4", "item:untamedwilds:egg_giant_salamander:6:4", "item:untamedwilds:egg_giant_salamander_hellbender:6:4", "item:untamedwilds:egg_giant_salamander_japanese:6:4", "item:untamedwilds:giant_clam:4:4", "item:untamedwilds:giant_clam_derasa:4:4", "item:untamedwilds:giant_clam_maxima:4:4", "item:untamedwilds:giant_clam_squamosa:4:4", "item:untamedwilds:egg_trevally_giant:6:4", "item:untamedwilds:egg_trevally:6:4", "item:untamedwilds:egg_trevally_bigeye:6:4", "item:untamedwilds:egg_sunfish:6:4", "item:untamedwilds:egg_sunfish_sunfish:6:4", "item:untamedwilds:egg_giant_clam_squamosa:6:4", "item:untamedwilds:egg_giant_clam_gigas:6:4", "item:untamedwilds:egg_giant_clam_derasa:6:4", "item:untamedwilds:egg_giant_clam:6:4", "item:untamedwilds:egg_football_fish:6:4", "item:untamedwilds:egg_arowana:6:4", "item:untamedwilds:egg_arowana_jardini:6:4", "item:untamedwilds:egg_arowana_green:6:4", "item:mysticalworld:raw_squid:6:5", "item:aquafina:fresh_soup:10:10", "item:aquafina:beluga_caviar:10:3", "item:aquafina:raw_piranha:4:1", "item:aquafina:raw_tilapia:4:1", "item:aquafina:stuffed_piranha:4:1", "item:aquafina:tigerfish:5:5", "item:aquafina:toe_biter_leg:3:3", "item:aquafina:raw_angelfish:4:1", "item:aquafina:raw_football_fish:4:1", "item:aquafina:raw_foxface_fish:4:1", "item:aquafina:raw_royal_gramma:4:1", "item:aquafina:raw_starfish:4:1", "item:aquafina:spider_crab_leg:4:1", "item:aquafina:raw_stingray_slice:4:1", "item:prehistoricfauna:raw_ceratodus:5:5", "item:prehistoricfauna:raw_cyclurus:4:4", "item:prehistoricfauna:raw_potamoceratodus:5:5", "item:prehistoricfauna:raw_myledaphus:4:4", "item:prehistoricfauna:raw_gar:4:4", "item:prehistoricfauna:raw_oyster:4:3", "item:prehistoric_delight:prehistoric_fillet:3:3", "item:seadwellers:rainbow_trout:10:10", "item:crittersandcompanions:koi_fish:5:5", "item:aquamirae:elodea:3:3", "item:croptopia:clam:3:3", "item:croptopia:calamari:2:3", "item:croptopia:anchovy:3:2", "item:croptopia:crab:6:8", "item:croptopia:glowing_calamari:4:5", "item:croptopia:oyster:2:4", "item:croptopia:roe:1:2", "item:croptopia:shrimp:2:2", "item:croptopia:tuna:6:4", "item:aquamirae:spinefish:4:4", "item:alexsmobs:flying_fish:6:4", "item:untamedwilds:egg_triggerfish:2:4", "item:untamedwilds:egg_catfish:2:4", "item:netherdepthsupgrade:eyeball:3:3", "item:netherdepthsupgrade:eyeball_fish:3:3", "item:oceansdelight:guardian:4:3", "item:oceansdelight:guardian_tail:1:3", "item:oceansdelight:cut_tentacles:3:1", "item:oceansdelight:tentacles:3:4", "item:oceansdelight:tentacle_on_a_stick:3:4", "item:oceansdelight:fugu_slice:5:4", "item:oceansdelight:elder_guardian_slice:8:6", "item:oceansdelight:elder_guardian_slab:15:15", "item:upgrade_aquatic:elder_eye:15:15", "item:unusualprehistory:golden_scau:15:15", "item:unusualprehistory:raw_scau:4:3", "item:unusualprehistory:raw_stetha:4:3", "item:unusualprehistory:stetha_eggs:4:3", "item:unusualprehistory:beelze_eggs:4:3", "item:unusualprehistory:scau_eggs:4:3", "item:unusualprehistory:ammon_eggs:4:3", "item:unusualprehistory:dunk_eggs:4:3"), ConfigHandler.itemsAndTagsPredicate.and(this::isValidFoodConfig));
		//Magic
