...
public class DragonAbilities
{
	...
	public static void initAbilities(){
		//Forest dragon
		POISONOUS_BREATH = register(DragonType.FOREST, new FireBreathAbility(DragonType.FOREST, "poisonous_breath", "forest/poisonous_breath", 1, 4, 2, Functions.secondsToTicks(2), Functions.secondsToTicks(5), new Integer[]{0, 10, 30, 50}));
		...
		//Sea dragon
		STORM_BREATH = register(DragonType.SEA, new FireBreathAbility(DragonType.SEA, "storm_breath", "sea/storm_breath", 1, 4, 2, Functions.secondsToTicks(2), Functions.secondsToTicks(5), new Integer[]{0, 10, 30, 50}));
