...
public class HelmetEntityRenderer extends TileEntityRenderer<HelmetTileEntity>{
	...
	public void render(HelmetTileEntity helmetEntity, float p_225616_2_, MatrixStack matrixStack, IRenderTypeBuffer renderTypeBuffer, int p_225616_5_, int p_225616_6_){
	...
	public static void renderHelmet(
		@Nullable
			Direction direction, float p_228879_1_, Block helmetBlock, float p_228879_4_, MatrixStack matrixStack, IRenderTypeBuffer renderTypeBuffer, int p_228879_7_){
