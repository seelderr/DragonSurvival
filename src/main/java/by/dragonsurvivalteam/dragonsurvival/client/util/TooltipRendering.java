...
public class TooltipRendering{
	...
	private static void drawHoveringText(PoseStack poseStack, List<Component> textLines, int x, int y, ItemStack itemStack, Font font){
		...
		List<ClientTooltipComponent> list = net.minecraftforge.client.ForgeHooksClient.gatherTooltipComponents(itemStack, textLines, tooltipImage, x, Math.min(x + 200, screen.width), screen.height, null);
