package by.dragonsurvivalteam.dragonsurvival.client.shader;
...
public class ShaderProgram{
	...
	private String readFile(String path){
		try{
			...
			BufferedReader reader = new BufferedReader(new InputStreamReader(Minecraft.getInstance().getResourceManager().getResource(new ResourceLocation(DragonSurvivalMod.MODID, path)).getInputStream(), StandardCharsets.UTF_8));
			String str;
