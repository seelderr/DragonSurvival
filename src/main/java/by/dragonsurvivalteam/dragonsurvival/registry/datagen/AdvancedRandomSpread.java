...
public class AdvancedRandomSpread extends RandomSpreadStructurePlacement {
    ...
    @Override
    public @NotNull RandomSpreadType spreadType() {
    ...
    @Override
    public @NotNull ChunkPos getPotentialStructureChunk(long seed, int x, int z) {
    ...
    @Override
    protected boolean isPlacementChunk(@NotNull ChunkGeneratorStructureState chunkGeneratorStructureState, int x, int z) {
