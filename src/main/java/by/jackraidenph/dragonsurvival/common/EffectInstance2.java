package by.jackraidenph.dragonsurvival.common;
...
public class EffectInstance2 extends MobEffectInstance
{
    ...
    public EffectInstance2(MobEffect effect, int duration, int strength, boolean ambient, boolean visible, boolean showIcon, @Nullable MobEffectInstance hiddenEffect) {
