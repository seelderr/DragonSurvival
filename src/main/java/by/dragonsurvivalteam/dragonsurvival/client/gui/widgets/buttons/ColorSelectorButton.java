...
public class ColorSelectorButton extends ExtendedButton {
    ...
    public void renderWidget(@NotNull final GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        active = !screen.preset.skins.get(screen.dragonLevel.getKey()).get().isDefaultSkin;
        ...
        DragonPart part = DragonEditorHandler.getDragonPart(FakeClientPlayerUtils.getFakePlayer(0, DragonEditorScreen.HANDLER), layer, screen.preset.skins.get(screen.dragonLevel.getKey()).get().settings.get(layer).get().selectedSkin, DragonEditorScreen.HANDLER.getType());
