...
public class GoodDragonArmorItem extends ArmorItem implements PermanentEnchantmentItem {
    public ItemEnchantments getDefaultEnchantments() {
        ...
        switch (this.getType()) {
            ...
            case CHESTPLATE -> EnchantmentUtils.addEnchantment(DSEnchantments.AERODYNAMIC_MASTERY, temp, 1);
            case LEGGINGS -> EnchantmentUtils.addEnchantment(DSEnchantments.UNBREAKABLE_SPIRIT, temp, 1);
