...
public class SourceOfMagicTileEntity extends BaseBlockTileEntity implements ITickableTileEntity, INamedContainerProvider {
    public int energy = 0;
    ...
    public static HashMap<Item, Integer> regenValue;

    static {
        regenValue = new HashMap<>(6);
        regenValue.put(DSItems.elderDragonDust, 5);
        regenValue.put(Items.IRON_INGOT, 10);
        regenValue.put(Items.GOLD_INGOT, 20);
        regenValue.put(Items.DIAMOND, 30);
        regenValue.put(DSItems.elderDragonBone, 40);
        regenValue.put(DSItems.elderDragonHeart, 64);
    }
