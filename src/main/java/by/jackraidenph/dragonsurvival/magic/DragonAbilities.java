...
public class DragonAbilities
{
	...
	public static void initAbilities(){
		...
		STRONG_LEATHER = register(DragonType.CAVE, new ToughSkinAbility(new EffectInstance(DragonEffects.STRONG_LEATHER), 5, ParticleRegistry.peaceBeaconParticle, "strong_leather", "cave/strong_leather", 0, 3, 5, Functions.secondsToTicks(5), Functions.secondsToTicks(30), new Integer[]{0, 15, 35}));
		...
		HOT_BLOOD = register(DragonType.CAVE, new HotBloodAbility("hot_blood", "cave/hot_blood", 1, 1));
	}
