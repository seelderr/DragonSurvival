...
public class SoundRegistry{
	...
	public static RegistryObject<SoundEvent> treasureGemBreak = SOUNDS.register("treasure_gem_break", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(DragonSurvivalMod.MODID, "treasure_gem_break")));
	public static RegistryObject<SoundEvent> treasureGemHit = SOUNDS.register("treasure_gem_hit", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(DragonSurvivalMod.MODID, "treasure_gem_hit")));
	...
	public static RegistryObject<SoundEvent> treasureMetalBreak = SOUNDS.register("treasure_metal_break", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(DragonSurvivalMod.MODID, "treasure_metal_break")));
	public static RegistryObject<SoundEvent> treasureMetalHit = SOUNDS.register("treasure_metal_hit", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation(DragonSurvivalMod.MODID, "treasure_metal_hit")));
	...
	private static SoundEvent register(String name){
		SoundEvent soundEvent = SoundEvent.createVariableRangeEvent(new ResourceLocation(DragonSurvivalMod.MODID, name));
