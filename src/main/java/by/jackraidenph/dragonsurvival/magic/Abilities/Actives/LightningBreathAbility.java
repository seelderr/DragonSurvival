...
public class LightningBreathAbility extends ActiveDragonAbility
{
	...
	public void onActivation(PlayerEntity player)
	{
		...
		if(level.isClientSide) {
			for (int i = 0; i < 24; i++) {
				...
				double ySpeed = speed * 1f * yComp;
				double zSpeed = speed * 1f * zComp;
				level.addParticle(new SmallLightningParticleData(37, true), x, y, z, xSpeed, ySpeed, zSpeed);
			}
			...
			for (int i = 0; i < 10; i++) {
				...
				level.addParticle(new LargeLightningParticleData(37, false), x, y, z, xSpeed, ySpeed, zSpeed);
			}
		}
