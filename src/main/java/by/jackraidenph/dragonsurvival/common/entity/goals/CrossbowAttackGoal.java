...
public class CrossbowAttackGoal<T extends PathfinderMob & RangedAttackMob & CrossbowAttackMob> extends Goal
{
   public static final ClampedInt PATHFINDING_DELAY_RANGE = ClampedInt.of(UniformInt.of(20, 40), 20, 40);
   private final T mob;
