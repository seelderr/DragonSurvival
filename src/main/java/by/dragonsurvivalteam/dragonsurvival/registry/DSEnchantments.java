...
public class DSEnchantments { // TODO :: chance description addition to 'enchantment.desc' for mod support (and shorten the text)
    ...
    @Translation(type = Translation.Type.ENCHANTMENT_DESCRIPTION, comments = "§5Dragonsbane §8(Weapon)§r: Inflict increased damage to dragons. If you kill a dragon who has the Hunter's Omen effect, they will lose some growth progress. Damages dragons who hold it.")
    ...
    @Translation(type = Translation.Type.ENCHANTMENT_DESCRIPTION, comments = "§4Blood Siphon §8(Head)§r: Has a chance to apply Blood Siphon to the enemy when you get hit, allowing you to recover a portion of the damage done.")
    ...
    @Translation(type = Translation.Type.ENCHANTMENT_DESCRIPTION, comments = "§4Murderer's Cunning §8(Chest)§r: You inflict increased damage to targets with full health.")
    ...
    @Translation(type = Translation.Type.ENCHANTMENT_DESCRIPTION, comments = "§4Overwhelming Might §8(Legs)§r: Debuffs you apply to targets are increased by 1 level.")
    ...
    @Translation(type = Translation.Type.ENCHANTMENT_DESCRIPTION, comments = "§4Draconic Superiority §8(Boots)§r: All damage you inflict is increased, and your melee damage is further increased.")
    ...
    @Translation(type = Translation.Type.ENCHANTMENT_DESCRIPTION, comments = "§6Combat Recovery §8(Head)§r: When you take damage, has a chance to apply Regeneration to yourself.")
    ...
    @Translation(type = Translation.Type.ENCHANTMENT_DESCRIPTION, comments = "§6Aerodynamic Mastery §8(Chest)§r: Reduces flight stamina cost, and has a chance to conserve rockets during elytra flight.")
    ...
    @Translation(type = Translation.Type.ENCHANTMENT_DESCRIPTION, comments = "§6Unbreakable Spirit §8(Legs)§r: Reduces incoming debuffs by 1 level.")
    ...
    @Translation(type = Translation.Type.ENCHANTMENT_DESCRIPTION, comments = "§6Sacred Scales §8(Boots)§r: Has a chance to reduce incoming damage.")
    ...
    @Translation(type = Translation.Type.ENCHANTMENT_DESCRIPTION, comments = "§4Outlaw's Mark §8(Armor)§r: Causes you to be a permanent target for dragon hunters.")
    ...
    @Translation(type = Translation.Type.ENCHANTMENT_DESCRIPTION, comments = "§6Mark of Compassion §8(Armor)§r: You deal reduced damage to dragon hunters and villagers.")
