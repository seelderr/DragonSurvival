...
public class CaveAthleticsAbility extends AthleticsAbility {
    ...
    public ResourceLocation[] getSkillTextures() {
        return new ResourceLocation[]{
                ResourceLocation.fromNamespaceAndPath(MODID, "abilities/cave/cave_athletics_0"),
                ResourceLocation.fromNamespaceAndPath(MODID, "abilities/cave/cave_athletics_1"),
                ResourceLocation.fromNamespaceAndPath(MODID, "abilities/cave/cave_athletics_2"),
                ResourceLocation.fromNamespaceAndPath(MODID, "abilities/cave/cave_athletics_3"),
                ResourceLocation.fromNamespaceAndPath(MODID, "abilities/cave/cave_athletics_4"),
                ResourceLocation.fromNamespaceAndPath(MODID, "abilities/cave/cave_athletics_5")
        };
    }
