...
public class CommonConfig{
	...
	public final ForgeConfigSpec.ConfigValue<List<? extends String>> fireBeaconEffects, magicBeaconEffects, peaceBeaconEffects;
	...
	CommonConfig(ForgeConfigSpec.Builder builder){
		...
		predatorHealthFactor = builder.defineInRange("predatorHealthFactor", 0.2, 0.2, 5);
		builder.push("spawnChances");
		minPredatorSpawn = builder.defineInRange("minimum", 0, 0, 64);
		maxPredatorSpawn = builder.defineInRange("maximum", 1, 0, 64);
		predatorSpawnWeight = builder.comment("Set weight to 0 to disable spawning.").defineInRange("weight", 2, 0, 100);
