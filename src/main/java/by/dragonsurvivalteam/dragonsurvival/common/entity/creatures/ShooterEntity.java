...
public class ShooterEntity extends Hunter implements ICrossbowUser{
	private static final DataParameter<Boolean> IS_CHARGING_CROSSBOW = EntityDataManager.defineId(ShooterEntity.class, DataSerializers.BOOLEAN);

	protected int bolasCooldown = Functions.secondsToTicks(30);

	public ShooterEntity(EntityType<? extends CreatureEntity> entityType, World world){
